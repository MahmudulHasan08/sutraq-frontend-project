...
import 'package:sutraq/ui/nav_page/settings/setting_bankaccount/notificationcopy.dart';
...
class NewAccountSutraqAndTransactingCopy extends StatefulWidget {
  const NewAccountSutraqAndTransactingCopy({Key? key}) : super(key: key);

  @override
  State<NewAccountSutraqAndTransactingCopy> createState() =>
      _NewAccountSutraqAndTransactingCopyState();
}

class _NewAccountSutraqAndTransactingCopyState
    extends State<NewAccountSutraqAndTransactingCopy> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () => Get.to(() => NotificationPageCopy()),
                child: Container(
                    margin: EdgeInsets.only(left: 10.w),
