...
import 'package:sutraq/ui/account_related/fundwalletcopy.dart';
...
class SettingsCopy extends StatefulWidget {
  const SettingsCopy({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SettingsCard("Bank Accounts"),
                  InkWell(
                      onTap: () => Get.to(() => FundWalletCopy()),
                      child: SettingsCard("My Cards")),
