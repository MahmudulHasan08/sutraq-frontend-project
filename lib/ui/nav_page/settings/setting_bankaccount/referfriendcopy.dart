...
import 'package:sutraq/ui/sutraqaccountandtransacting/sutraqaccountandtransactingcopy.dart';
import 'package:sutraq/ui/widgets/big_text.dart';
import 'package:sutraq/ui/widgets/small_text.dart';

class ReferFriendCopy extends StatelessWidget {
  const ReferFriendCopy({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: InkWell(
                      onTap: () =>
                          Get.to(() => NewAccountSutraqAndTransactingCopy()),
                      child: Container(
                        padding: EdgeInsets.all(20.w),
                        height: 74.h,
                        width: 227.w,
