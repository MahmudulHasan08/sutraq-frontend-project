...
import 'package:sutraq/ui/sutraqaccountandtransacting/sutraaccountandtransactingnewaccount.dart';
...
class TransferSutraqUserSuccess extends StatefulWidget {
  const TransferSutraqUserSuccess({Key? key}) : super(key: key);

  @override
  State<TransferSutraqUserSuccess> createState() =>
      _TransferSutraqUserSuccessState();
}

class _TransferSutraqUserSuccessState extends State<TransferSutraqUserSuccess> {
  @override
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                      onTap: () {
                        Get.snackbar("Done", "We’d Like to know you better.",
                            backgroundColor: AppColors.mainColor,
                            colorText: AppColors.whiteColor);
                        Get.to(() => SutraqAccountAndtransactingNewAccount());
                      },
