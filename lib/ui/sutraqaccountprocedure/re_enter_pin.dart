...
import 'package:sutraq/ui/sutraqaccountprocedure/successfullyfunded.dart';
...
class ReEnterPin extends StatefulWidget {
  const ReEnterPin({Key? key}) : super(key: key);
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              InkWell(
                  onTap: () => Get.to(() => SuccesfullyFunded()),
