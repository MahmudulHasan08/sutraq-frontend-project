...
class AddNewSutraBankCard extends StatefulWidget {
  const AddNewSutraBankCard({Key? key}) : super(key: key);

  @override
  State<AddNewSutraBankCard> createState() => _AddNewSutraBankCardState();
}

class _AddNewSutraBankCardState extends State<AddNewSutraBankCard> {
  @override
