...
import 'package:sutraq/ui/account_related/withdrawfundscopy.dart';
...
class FundWallet2Copy extends StatefulWidget {
  const FundWallet2Copy({Key? key}) : super(key: key);

  @override
  State<FundWallet2Copy> createState() => _FundWalletState();
}

class _FundWalletState extends State<FundWallet2Copy> {
  @override
                  ...
                  children: [
                    ...
                    Positioned(
                        ...
                        child: Container(
                          margin: EdgeInsets.only(left: 10.w),
                          child: InkWell(
                              onTap: () => Get.to(() => WithDrawFundsCopy()),
