...
import 'package:sutraq/ui/nav_page/settings/setting_bankaccount/referfriendcopy.dart';
...
class WithDrawFundsCopy extends StatefulWidget {
  const WithDrawFundsCopy({Key? key}) : super(key: key);

  @override
  State<WithDrawFundsCopy> createState() => _WithDrawFundsCopyState();
}

class _WithDrawFundsCopyState extends State<WithDrawFundsCopy> {
  @override
